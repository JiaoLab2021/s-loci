#ifndef kmer_bit_genotype_hpp
#define kmer_bit_genotype_hpp
#include <fstream>
#include <string>
#include <vector>
...
namespace kmerBitGenotype{
	 ...
	 */
	void kmer_sketch(const uint64_t chromosomeId, const string & str, unsigned int k, unordered_map<uint64_t, vector<uint64_t> > & outMap)
	{
